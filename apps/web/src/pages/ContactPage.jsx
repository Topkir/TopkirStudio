...
const inputCls =
  'w-full rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-white/[0.03] px-4 py-3 text-white dark:text-white placeholder:text-gray-500 dark:placeholder:text-white/40 caret-black dark:caret-white outline-none transition-colors focus:border-black/30 dark:focus:border-white/30';
